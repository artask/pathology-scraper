...
if ($html = file_get_html('http://www.med.nyu.edu/pathology/people/faculty')) {
    $i = 0;
    foreach($html->find('.view-content .views-field-title a') as $link_tag) {
        ...
        //if(!in_array($link, $links)) {    
            ...
            if ($doctor_page = file_get_html($link)) {
                if (strpos($link, 'nyulangone.org/doctors') !== false) {
                ...
                if (strpos($link, 'med.nyu.edu/biosketch') !== false) {
