...
if(isset($_GET['name'])) {
    ...
    if (mysqli_num_rows($result)) {
        ...
        while ($row = $result->fetch_object()) { 
            ...
            //$image_url = $row->image == '' ? ' http://www.med.nyu.edu/pathology/sites/default/files/pathology/leadership/images/sillhouette-male-150_5.jpg' : $row->image;
            //$output .= '<div class="image-wrapper"><img src="'.$image_url.'" width="150" height="200" alt=""></div>';
